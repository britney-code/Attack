...
from dataset import AdvDataset, AdvImagetNet
...
def parse_args_and_config():
    ...
    # diffusion models
    parser.add_argument('--image_folder', type=str, default='../../data', help="The folder name of samples")
    parser.add_argument('--adv_dir', type=str, default='../../result/apens', help='Path of adversarial examples.')
    ...
    parser.add_argument('--adv_batch_size', type=int, default=10)
...
if __name__ == '__main__':
    ...
    dataset = AdvImagetNet(input_dir=args.image_folder, output_dir=args.adv_dir,
    ...
    correct, total = 0, 0
    for i, (images, labels, filenames) in enumerate(tqdm.tqdm(dataloader)):
        if args.targeted:
